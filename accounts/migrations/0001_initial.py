    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(error_messages={'unique': 'User with such email already exists. Choose another email, or login via one'}, help_text='Required field! Ex: my_email@example.com', max_length=254, unique=True, verbose_name='Email')),
